  ...
  class Qytetet
    ...
    def aplicar_sorpresa
      ...
      when TipoSorpresa::CONVERTIRME
        ...
        # Reemplazar al jugador actual pos su especulador
        for i in 0..longitud
    ...
    def edificar_casa(casilla)
      ...
      if casilla.soy_edificable
        if casilla.se_puede_edificar_casa(@jugador_actual.factor_especulador)
    ...
    def inicializar_cartas_sorpresa 
      @mazo = Array.new
      @mazo << Sorpresa.new("te has convertido en un especulador", 3000, TipoSorpresa::CONVERTIRME)
      ...
      @mazo << Sorpresa.new("Te has convertido en un especulador", 5000, TipoSorpresa::CONVERTIRME)
    end
