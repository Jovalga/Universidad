#ifndef _VORAZ_MAXIMODATOS__
#define _VORAZ_MAXIMODATOS__
#include <iostream>
#include <fstream>
...
/**	
*	@brief: Método que selecciona de un vector de enteros un subconjunto de ellos, cuyo resultado es igual al parámetro suma.
